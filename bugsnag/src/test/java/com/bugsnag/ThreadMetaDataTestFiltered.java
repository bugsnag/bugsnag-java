...
public class ThreadMetaDataTestFiltered {
    ...
    @Test
    public void testMetaDataClearAllFiltered() {
    ...
    @Test
    public void testMetaDataClearTabFiltered() {
        ...
        assertTrue(report.getFilteredMetaData().containsKey("tab2"));
        ...
        assertTrue(report.getFilteredMetaData().containsKey("tab1"));
        assertEquals("some value", getMetaDataMap(notification, "tab1").get("some key"));
        assertFalse(report.getFilteredMetaData().containsKey("tab2"));
    }

    @Test
    public void testMetaDataClearKeyFiltered() {
    ...
    @Test
    public void testInnerThreadMetaDataFiltered() {
        ...
        assertTrue(report.getFilteredMetaData().containsKey("innerthread"));
        assertEquals("value should be in report",
                getMetaDataMap(notification, "innerthread").get("some key"));

        assertFalse(report.getFilteredMetaData().containsKey("outerthread"));
    }

    @Test
    public void testUnhandledThreadMetaDataRemovalFiltered() {
    ...
    @Test
    public void testUnhandledThreadMetaDataFiltered() {
