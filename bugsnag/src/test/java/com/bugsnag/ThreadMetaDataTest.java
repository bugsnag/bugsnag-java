...
public class ThreadMetaDataTest {
    ...
    public void testMetaDataClearTabRedacted() {
        ...
        assertEquals("some value", getRedactedMetaDataMap(notification, "tab1").get("some key"));
        assertTrue(report.getRedactedMetaData().containsKey("tab2"));
        assertEquals("some value", getRedactedMetaDataMap(notification, "tab2").get("some key"));
    ...
    public void testMetaDataClearKeyRedacted() {
        ...
        Report report = notification.getEvents().get(0);
        assertTrue(report.getRedactedMetaData().containsKey("tab1"));
        assertEquals("some value", getRedactedMetaDataMap(notification, "tab1").get("key1"));
        assertEquals("some value", getRedactedMetaDataMap(notification, "tab1").get("key2"));
        ...
        assertTrue(report.getRedactedMetaData().containsKey("tab1"));
        assertEquals("some value", getRedactedMetaDataMap(notification, "tab1").get("key1"));
        assertFalse(getRedactedMetaDataMap(notification, "tab1").containsKey("key2"));
    }
    ...
    public void testUnhandledThreadMetaDataRemovalRedacted() {
        ...
        assertTrue(report.getRedactedMetaData().containsKey("thread"));
        assertFalse(getRedactedMetaDataMap(notification, "thread").containsKey("key1"));
        assertEquals("should be included in meta data",
                getRedactedMetaDataMap(notification, "thread").get("key2"));
    }
    ...
    public void testUnhandledThreadMetaDataRedacted() {
        ...
        assertEquals("value should be in report",
                getRedactedMetaDataMap(notification, "innerthread").get("some key"));
